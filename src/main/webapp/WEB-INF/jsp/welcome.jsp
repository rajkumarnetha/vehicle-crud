...
<html>
   <head>
      <title>Vehicle - CRUD Assessment </title>
      ...
      <div class="container">
         <div class="row">
            <div class="col-lg-12 margin-tb">
               <div class="pull-left">
                  <h2>Vehicle - CRUD Assessment</h2>
               </div>
               <div class="pull-right">
                  <button type="button" class="btn btn-success" data-toggle="modal"
                     data-target="#create-item">Create Item</button>
               </div>
            </div>
         </div>
               ...
               <div class="modal-content">
                  ...
                  <div class="modal-body">
                     <form data-toggle="validator" action="" method="put">
                        <div class="form-group">
                           <label class="control-label" for="title">Type:</label> <input
         ...
         <div class="pull-left">
                  <button type="button" class="btn btn-success" data-toggle="modal"
                     data-target="#search-item">Search Item</button>
          </div>
          <!-- Search Item Modal -->
         <div class="modal fade" id="search-item" tabindex="-1" role="dialog"
            aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
               <div class="modal-content">
                  <div class="modal-header">
                  ...
                  <div class="modal-body">
                     <form data-toggle="validator" action="/searchVehicle" method="POST">
                        <div class="form-group">
                           <label class="control-label" for="title">Type:</label> 
                           <select class="form-control" data-error="Please enter title." name="title" type="text" required>
                              <option value="AirPlane">AirPlane</option>
